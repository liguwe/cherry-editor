...
import { getEditableLink } from '../../../../../../../plugins/link/main/ts/core/Utils';
...
const getSpec = (editor: Editor): SelectSpec => {
  ...
  const onAction = (rawItem: FormatterFormatItem) => () => {
    const specialLink = getEditableLink(editor, 'mode', 'insert');
    editor.fire('insertLinkFontSize', { insertLink: specialLink, size: rawItem.format });
