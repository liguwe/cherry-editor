...
tinymce.addI18n('zh_CN', {
  ...
  'Padding': '内边距',
  'Comfirm': '确认',
  'Table Alignment': '表格对齐',
  'Tencent Doc': '腾讯文档',
  'Insert Tencent Doc': '插入已有文档',
  'New Online Doc': '新建在线文档',
  'New Online Sheet': '新建在线表格',
  'New Online Slide': '新建在线幻灯片',
  'No more data': '没有更多数据了',
  'Save & Exit': '保存并退出',
  'From': '来自',
  'Copy & Insert': '复制并插入',
  'LastModified': '最近修改',
  'Tencent documents will be inserted into TAPD by copying new copies, and the inserted copies will be controlled by TAPD editing rights.': '腾讯文档将以复制新建副本的方式插入到TAPD，插入的副本将受TAPD需求编辑权限控制。',
  'Insert ': '插入',
  'CoDesign': '设计稿',
  'Card Preview': '卡片预览',
  'Text Link': '文字链',
